export type TickpadPermission = "document:read" | "document:write" | "clipboard:read" | "clipboard:write" | "network" | "fs:read" | "fs:write";
...
export interface ExporterContribution {
    id: string;
    title: string;
    export: (markdown: string) => string | Promise<string>;
}
